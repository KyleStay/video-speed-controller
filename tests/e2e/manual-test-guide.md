# Manual E2E Testing Guide for StayFast Video
...
3. Look for the StayFast Video overlay (small speed indicator)
...
- Check if StayFast Video is enabled in `chrome://extensions/`
- Refresh the page
